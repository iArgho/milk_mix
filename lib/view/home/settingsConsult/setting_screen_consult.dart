...
class SettingScreenConsult extends StatelessWidget {
  const SettingScreenConsult({super.key});
          ...
          child: Column(
            ...
            children: [
              ...
              SettingTile(
                ...
                onTap: () {
                  Get.toNamed(AppRoutes.editProfileConsult);
                },
              ),
              SettingTile(
                ...
                onTap: () {
                  Get.toNamed(AppRoutes.subscriptionConsult);
                },
              ),
              SettingTile(
                ...
                title: 'language'.tr,
                onTap: () {
                  Get.toNamed(AppRoutes.editLanguageConsult);
                },
              ),
              SettingTile(
                ...
                onTap: () {
                  Get.toNamed(AppRoutes.editMeasurementConsult);
                },
              ),
              SettingTile(
                ...
                onTap: () {
                  Get.toNamed(AppRoutes.changePasswordConsult);
                },
              ),
              SettingTile(
                ...
                onTap: () {
                  Get.toNamed(AppRoutes.helpAndSupportConsult);
                },
              ),
              SettingTile(
